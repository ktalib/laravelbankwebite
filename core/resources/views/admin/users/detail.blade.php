        ...
        <div class="col-12">
            <div class="row gy-4">
                <div class="col-xxl-3 col-xl-8 col-sm-6">
                    <x-widget style="2" color="info" icon="la la-money-bill-wave-alt" title="Balance" value="{{ $general->cur_sym }}{{ showAmount($user->balance) }}" link="admin.report.transaction" query_string="search={{ $user->username }}" overlay_icon=0 icon_style=solid />
                </div>

                <div class="col-xxl-3 col-xl-4 col-sm-6">
                    <x-widget style="2" color="success" icon="la la-wallet" title="Deposited" value="{{ $general->cur_sym }}{{ showAmount($widget['total_deposit']) }}" link="admin.deposit.list" query_string="search={{ $user->username }}" overlay_icon=0 icon_style=solid />
                </div>

                <div class="col-xxl-3 col-xl-4 col-sm-6">
                    <x-widget style="2" color="danger" icon="la la-wallet" title="Withdrawn" value="{{ $general->cur_sym }}{{ showAmount($widget['total_withdrawn']) }}" link="admin.withdraw.log" query_string="search={{ $user->username }}" overlay_icon=0 icon_style=solid />
                </div>

                <div class="col-xxl-3 col-xl-4 col-sm-6">
                    <x-widget style="2" color="warning" icon="la la-exchange-alt" title="Total Transferred" value="{{ $general->cur_sym }}{{ showAmount($widget['total_transferred']) }}" link="admin.transfers.index" query_string="search={{ $user->username }}" overlay_icon=0 icon_style=solid />
                </div>

                <div class="col-xxl-3 col-xl-4 col-sm-6">
                    <x-widget style="2" color="primary" icon="la la-money-bill" title="FDR" value="{{ $widget['total_fdr'] }}" link="admin.fdr.index" query_string="search={{ $user->username }}" overlay_icon=0 icon_style=solid />
                </div>

                <div class="col-xxl-3 col-xl-4 col-sm-6">
                    <x-widget style="2" color="green" icon="la la-box" title="DPS" value="{{ $widget['total_dps'] }}" link="admin.dps.index" query_string="search={{ $user->username }}" overlay_icon=0 icon_style=solid />
                </div>

                <div class="col-xxl-3 col-xl-4 col-sm-6">
                    <x-widget style="2" color="warning" icon="la la-hand-holding-usd" title="Loan" value="{{ $widget['total_loan'] }}" link="admin.loan.index" query_string="search={{ $user->username }}" overlay_icon=0 icon_style=solid />
                </div>
        ...
        <div class="col-12">
            <div class="d-flex flex-wrap gap-3">
                ...
                @can('admin.report.login.history')
                    <div class="flex-fill">
                        <a href="{{ route('admin.report.login.history') }}" class="btn btn--primary btn--shadow w-100 btn-lg">
                    ...
                    <div class="flex-fill">
                        @if ($user->status == Status::USER_ACTIVE)
                            <button type="button" class="btn btn--warning btn--gradi btn--shadow w-100 btn-lg userStatus" data-bs-toggle="modal" data-bs-target="#userStatusModal">
                                <i class="las la-ban"></i>@lang('Freeze Account')
                            </button>
                        @else
                            <button type="button" class="btn btn--success btn--gradi btn--shadow w-100 btn-lg userStatus" data-bs-toggle="modal" data-bs-target="#userStatusModal">
                                <i class="las la-undo"></i>@lang('Unfreeze Account')
                            </button>
                        @endif
                    </div>
                @endcan
