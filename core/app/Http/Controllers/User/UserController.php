...
class UserController extends Controller
{
    ...
    public function depositHistory(Request $request)
    {
        ...
        $deposits  = auth()->user()->deposits()->searchable(['trx'])->with(['gateway', 'branch'])->orderBy('id', 'desc');
        if ($status) $deposits->where('status', $status);
    ...
    public function transactions()
    {
        ...
        if (request()->today) {
            $transactions->whereDate('created_at', now()->today());
        }
    ...
    public function userDataSubmit(Request $request)
    {
        ...
        $user->dateofbith = $request->dateofbith;
    ...
    public function transferHistory()
    {
        ...
        if (request()->download == 'pdf') {
            ...
            return downloadPDF($this->activeTemplate . 'pdf.transfer_list', compact('pageTitle', 'transfers'));
        }
